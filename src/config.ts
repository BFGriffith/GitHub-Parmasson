...
export const SIDEBAR: Sidebar = {
	en: {
		'GitHub Repositories': [
			...
			{ text: 'FluidVoice', link: 'GitHub-Parmasson/en/FluidVoice' },
			{ text: 'voicebox', link: 'GitHub-Parmasson/en/voicebox' },
			{ text: 'OpenCut', link: 'GitHub-Parmasson/en/OpenCut' },
			{ text: 'penpot', link: 'GitHub-Parmasson/en/penpot' },
		],
